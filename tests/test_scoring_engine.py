...
class TestOverallScoreCalculation:
    ...
    def test_custom_rules_weight_zero_has_no_impact(self, engine):
        ...
        # FIX H-02 VERIFIED: custom_rules now has weight=0.05
        # A codebase with 50 critical custom rule violations now scores lower
        assert score_without > score_with, (
            "custom_rules with weight=0.05 should cause score drop when violations exist"
        )
