...
class AnalysisResult:
    ...
    def merge_with(self, other: "AnalysisResult") -> "AnalysisResult":
        ...
        # FIX CR-22 / LV-05: Original logic was accidental — used coincidental
        # ordering rather than explicit priority. 5 of 16 combinations were wrong
        # (notably PARTIAL + FAILED → PARTIAL and SKIPPED + anything → SKIPPED).
        # Correct rule: worst status wins, priority: FAILED > PARTIAL > SUCCESS > SKIPPED.
        _PRIORITY = [
            ResultStatus.FAILED,
        ...
        def _worse_status(a: ResultStatus, b: ResultStatus) -> ResultStatus:
            return a if _PRIORITY.index(a) <= _PRIORITY.index(b) else b
