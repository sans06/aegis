...
# FIX CR-01: Renamed from FileNotFoundError to avoid shadowing Python built-in.
# The original name caused any 'except FileNotFoundError' after importing this
# module to catch this class instead of Python's builtins.FileNotFoundError,
# silently swallowing real I/O errors.
class SourceNotFoundError(InputError):
    """Raised when a source file or directory is not found."""
    pass


# Backward-compatibility alias — allows gradual migration of callers.
# Remove once all call sites are updated.
FileNotFoundInputError = SourceNotFoundError
