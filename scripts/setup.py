...
def main():
    """Main setup function."""
    print("\n" + "="*60)
    print("[LAUNCH] Synexian Agent Setup")
    print("="*60)
    ...
    if not env_file.exists() and env_example.exists():
        print("\n[NOTE] Creating .env file from .env.example")
        env_file.write_text(env_example.read_text())
        print("[OK] .env file created")
        print("[WARN]  Please edit .env and add your OpenRouter API key")
    else:
    ...
    # Verify installation
    print("\n" + "="*60)
    print("[SEARCH] Verifying Installation")
    print("="*60)
    ...
    try:
        ...
        print(result.stdout)
        print("[OK] Synexian Agent is installed correctly!")
